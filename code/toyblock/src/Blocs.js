...
const text2 = <div>
                <div>
                Donnons un carnet à chaque habitant qui veut pouvoir échanger sa monnaie. Une fois que 2 animaux se sont mis d’accord sur une transaction, ils l’écrivent dans leur fichier propre, et envoient une lettre à tous les habitants du village : « Attention, inscrivez que Pingouin a donné 2 Infocoin à Paresseux ». Tout le monde le note dans son propre carnet.
                </div> 
                <h2>
                Problème:
                </h2>
                <div>
                Renard a vite besoin d’argent pour acheter une tarte. Il écrit dans une lettre : « Inscrivez tous que Grenouille m’a donné 100 Infocoins ! ». Le reste du village reçoit la lettre, et ils copient la transaction dans leur carnet. 
...
const text3 = <div>
                ...
                <div>
                Cette fois-ci, Renard a envie d’un cookie, et d’un jus de fruits, coûtant 5 Infocoin chacun ! Problème : Renard est presque à sec, il ne lui reste que 5 Infocoin. Pourtant, il a très envie d’acheter les deux douceurs. Il trouve une stratégie.
                Renard prépare 2 lettres : L’une d’elle dit qu’il a dépensé 5 Infocoins dans un cookie, l’autre qu’il les a dépensés dans un jus de fruit. Il les enferme dans leur coffre, avec la serrure renard. Il envoie sa première lettre à un coin du village, et court vite de l’autre côté pour envoyer la deuxième.
                Pingouin reçoit d’abord la première lettre. Il vérifie dans son carnet, et voit que Renard a acheté un cookie avec ses 5 derniers Infocoins. Il note l’info, et retransmet la lettre au reste du village. Pendant ce temps-là, de l’autre côté, Paresseux reçoit la lettre numéro 2. Il vérifie, selon son carnet, Renard possède encore 5 Infocoins. Il ne voit donc aucun problème à inscrire la transaction !
...
const text7 = <div>
                <div>
                Le chef du village réagit : Après chaque cycle, l’animal ayant fourni la proof of work recevra 10 Infocoins créés juste pour lui, qu’il peut dépenser comme il l’entend. Ainsi, cela motive les habitants à lutter pour la sécurité de tous !
                </div> 
                <h2>
                Problème:
                </h2>
                <div>
                Le village grandit et le système Infocoin a beaucoup de succès ! Mais il grandit tellement, qu’au final, Pingouin n’arrive plus jamais à trouver le nombre. Quelqu’un de plus rapide réussit toujours avant lui.
                </div>
        </div>
